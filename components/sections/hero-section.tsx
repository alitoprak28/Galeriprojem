      ...
      <div className="page-shell">
        <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <motion.div
            ...
            className="space-y-6 border border-foreground/10 bg-panel p-6 shadow-panel sm:p-8"
          >
            <div className="space-y-3">
              <span className="eyebrow">İstanbul Maslak ikinci el araç stoğu</span>
              <h1 className="text-balance font-display text-5xl uppercase tracking-[-0.05em] text-foreground sm:text-6xl lg:text-7xl">
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="inline-flex items-center gap-3 border border-foreground/10 bg-foreground/[0.04] px-5 py-3 text-xs font-medium uppercase tracking-[0.24em] text-foreground transition hover:border-foreground/20 hover:bg-foreground/[0.08]"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-3 border border-foreground/10 px-5 py-3 text-xs font-medium uppercase tracking-[0.24em] text-foreground transition hover:border-foreground/20 hover:bg-foreground/[0.05]"
              >
          ...
          >
            <div className="relative min-h-[21rem] overflow-hidden border border-foreground/10 bg-panel shadow-panel sm:min-h-[24rem]">
              <ParallaxMedia
              ...
              <div className="absolute inset-x-0 bottom-0 p-5 sm:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                  <div>
                    ...
                    <h2 className="mt-2 font-display text-3xl uppercase tracking-[-0.04em] text-white">
                      {heroVehicle.title}
                    </h2>
